...
var MemStorage = class {
  ...
  async getAllAttacks(filters) {
    ...
    if (filters) {
      ...
      if (filters.casualtyMin !== void 0 && filters.casualtyMin > 0) {
        attacks = attacks.filter((a) => a.killed + a.wounded >= filters.casualtyMin);
      }
      if (filters.casualtyMax !== void 0 && filters.casualtyMax < 3e3) {
        attacks = attacks.filter((a) => a.killed + a.wounded <= filters.casualtyMax);
      }
      if (filters.searchQuery) {
        const query = filters.searchQuery.toLowerCase();
        attacks = attacks.filter(
          (a) => a.city.toLowerCase().includes(query) || a.country.toLowerCase().includes(query) || a.region.toLowerCase().includes(query) || a.attackType.toLowerCase().includes(query) || a.description.toLowerCase().includes(query)
        );
      }
    }
...
function registerRoutesSync(app2) {
  app2.get("/api/attacks", async (req, res) => {
    try {
      const filters = {
        dateFrom: req.query.dateFrom,
        dateTo: req.query.dateTo,
        countries: req.query.countries ? Array.isArray(req.query.countries) ? req.query.countries : [req.query.countries] : void 0,
        regions: req.query.regions ? Array.isArray(req.query.regions) ? req.query.regions : [req.query.regions] : void 0,
        attackTypes: req.query.attackTypes ? Array.isArray(req.query.attackTypes) ? req.query.attackTypes : [req.query.attackTypes] : void 0,
        severities: req.query.severities ? Array.isArray(req.query.severities) ? req.query.severities : [req.query.severities] : void 0,
        casualtyMin: req.query.casualtyMin ? parseInt(req.query.casualtyMin) : void 0,
        casualtyMax: req.query.casualtyMax ? parseInt(req.query.casualtyMax) : void 0,
  ...
  app2.get("/api/attacks/:id", async (req, res) => {
    try {
